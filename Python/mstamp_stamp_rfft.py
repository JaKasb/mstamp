...
import numpy as np
try:
    # If the input data type is real, scipy.fftpack automatically performs
    # a “real FFT” algorithm, which roughly halves the fft computation time.
    from scipy.fftpack import fft, ifft
except ImportError:
    raise ImportWarning('Falling back to numpy.fft instead of scipy.fftpack')
